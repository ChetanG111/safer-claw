...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      quote:
        'Safer-Claw is a free alternative to ShipFast, designed to simplify and optimize your shipping process.',
      name: 'developer.joy',
      title: '@developer.joy',
        ...
        <div className='border border-[#E4E4E7] rounded-none overflow-hidden bg-transparent'>
          <div className='grid grid-cols-1 md:grid-cols-3 auto-rows-auto'>
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`p-4 md:p-6 bg-transparent flex flex-col relative border-b last:border-b-0 border-[#E4E4E7] md:border-b-0 ${
