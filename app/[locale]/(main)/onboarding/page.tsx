...
const AGENT_CONFIGS = [
  {
    ...
    title: 'Support Agent',
    description:
      'Automate customer support on WhatsApp & Telegram. Handle FAQs and tickets instantly.',
    icon: MessageSquare,
  ...
  },
  {
    ...
    title: 'Sales Rep',
    description:
      'Qualify leads and book meetings 24/7. engage visitors and turn them into customers.',
    icon: Briefcase,
  ...
  },
  {
    ...
    description:
      'Connect your tools and automate internal workflows. Streamline your business operations.',
    icon: Bot,
  ...
  },
  {
    ...
    description:
      'Build your own agent logic from scratch. Connect any API and design custom behaviors.',
    icon: Zap,
    ...
    <div className='container max-w-5xl mx-auto py-12 px-4 md:py-20'>
      <BounceSequence className='text-center mb-12'>
        ...
        <p className='text-lg text-slate-500 max-w-2xl mx-auto'>
          Select a template to initialize your AI agent. You can customize its behavior and
          connections later.
        </p>
      </BounceSequence>
      ...
      <BounceSequence initialDelay={0.6} className='flex justify-center'>
        <Button
